...
| 1-26 | 初期データ投入（ドンデコルテさん関連） | 2h | 1-25 |
...
→ cast テーブルに複数行入れる。例：ドンデコルテさんの動画にゲストが1人ピンで出演
→ video_casts に2行: comedy_group_id=ドンデコルテさん, artist_id=ゲスト
...
### サイトの位置づけ
→ 非公式ファンサイト。ドンデコルテさんおよび吉本興業とは無関係。
