...
const TEXTAREA_CLASS =
  "w-full resize-y rounded-md border border-brand-border-dark bg-brand-bg-dark px-3 py-2 text-sm text-brand-cream outline-none transition focus:border-brand-sky";
