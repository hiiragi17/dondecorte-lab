...
import { buildSearchUrl, fetchPolite, USER_AGENT } from "./client";
...
describe("buildSearchUrl", () => {
  it("キーワードを URL エンコードして検索 URL を作る", () => {
    expect(buildSearchUrl("ドンデコルテ")).toBe(
      "https://ticket.fany.lol/search/event?keywords=%E3%83%89%E3%83%B3%E3%83%87%E3%82%B3%E3%83%AB%E3%83%86&search_type=search_string"
    );
  });
});
